...
export default function Services() {
  ...
  return (
    <AnimatedPage>
      ...
      {/* Page Banner */}
    <section className="page-banner" style={{"backgroundImage":"url('images/hero_infrastructure.png')"}}>
        ...
        <div className="container">
            ...
            <div className="grid-3" style={{"gap":"30px"}}>
                ...
                <div className="service-card fade-in-up" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                    <img src="images/civil_engineering_site.png" alt="Civil Engineering Construction Services AXIS INFINITY STRUCTURE" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                ...
                <div className="service-card fade-in-up delay-1" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                    <img src="images/mechanical_works_pipes.png" alt="Mechanical Engineering" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                    <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
                ...
                <div className="service-card fade-in-up delay-2" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                    <img src="images/ei_works_panel.png" alt="Electrical and Instrumentation Works AXIS INFINITY STRUCTURE" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                    <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
                ...
                {/* CCTV */}
                <div className="service-card fade-in-up" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                    <img src="images/cctv-installation.jpg" alt="CCTV & Security Systems" style={{"width":"100%","height":"220px","objectFit":"cover","objectPosition":"center"}} />
                    <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
                ...
                {/* Manpower */}
                <div className="service-card fade-in-up delay-1" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                    <img src="images/manpower_supply.png" alt="Manpower Supply" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                    <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
                ...
                {/* Transport */}
                <div className="service-card fade-in-up delay-2" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                    <img src="images/user_transport.png" alt="Transport Rental" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                    <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 10 */}
            <div className="service-card fade-in-up" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/hvac_maintenance_technician.png" alt="HVAC Maintenance" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 12 */}
            <div className="service-card fade-in-up delay-2" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_steel_fabrication.png" alt="Steel Fabrication" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
                    <div className="card-icon mb-3"><i className="ph ph-buildings"></i></div>
            ...
            {/* Service 13 */}
            <div className="service-card fade-in-up" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_industrial_insulation.png" alt="Industrial Insulation" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 14 */}
            <div className="service-card fade-in-up delay-1" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_ndt_inspection.png" alt="NDT & Inspection" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 15 */}
            <div className="service-card fade-in-up delay-2" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_marine_offshore.png" alt="Marine & Offshore" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 18 */}
            <div className="service-card fade-in-up delay-2" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_water_wastewater.png" alt="Water Treatment" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 19 */}
            <div className="service-card fade-in-up" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_geotechnical.png" alt="Geotechnical Piling" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 23 */}
            <div className="service-card fade-in-up" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_procurement.png" alt="Procurement and Supply Chain" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
            ...
            {/* Service 24 */}
            <div className="service-card fade-in-up delay-1" style={{"padding":"0","overflow":"hidden","display":"flex","flexDirection":"column","backgroundColor":"#f8f9fa"}}>
                <img src="images/service_facility.png" alt="Facility Management" style={{"width":"100%","height":"220px","objectFit":"cover"}} />
                <div style={{"padding":"30px","flex":"1","display":"flex","flexDirection":"column"}}>
                    <div className="card-icon mb-3"><i className="ph ph-buildings"></i></div>
