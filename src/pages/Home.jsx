            ...
            <div className="premium-hero-right">
                <div className="premium-image-col">
                    <div className="img-wrapper">
                        <img src="images/hero section image.webp" alt="Civil Engineering Site Hero Image"  width="1200" height="800" loading="eager" fetchpriority="high" decoding="async" />
                    </div>
        ...
        <div className="container">
            <div className="why-header-new fade-in-up" style={{"display":"flex","justifyContent":"space-between","alignItems":"center","gap":"40px","marginBottom":"50px","flexWrap":"wrap"}}>
                ...
                <div className="why-header-image">
                    <img src="images/why_choose_axis.webp" alt="AXIS Infinity Structure Planning and Execution"  width="1024" height="1024" loading="lazy" decoding="async" />
                </div>
            </div>
            ...
            <div className="premium-sector-grid">
                ...
                <div className="sector-card-premium fade-in-up">
                    <div className="sector-card-img-wrapper">
                        <img src="images/project_highway.webp" alt="Infrastructure Projects"  width="576" height="432" loading="lazy" decoding="async" />
                ...
                <div className="sector-card-premium fade-in-up delay-1">
                    <div className="sector-card-img-wrapper">
                        <img src="images/project_industrial_park.webp" alt="Industrial Facilities"  width="638" height="480" loading="lazy" decoding="async" />
                ...
                <div className="sector-card-premium fade-in-up delay-2">
                    <div className="sector-card-img-wrapper">
                        <img src="images/oil and gas refineries.webp" alt="Oil & Gas Refineries"  width="736" height="786" loading="lazy" decoding="async" />
                ...
                <div className="sector-card-premium fade-in-up">
                    <div className="sector-card-img-wrapper">
                        <img src="images/project_shutdown.webp" alt="Fertilizer Plants"  width="678" height="452" loading="lazy" decoding="async" />
                ...
                <div className="sector-card-premium fade-in-up delay-1">
                    <div className="sector-card-img-wrapper">
                        <img src="images/project_automation.webp" alt="Petrochemical"  width="597" height="335" loading="lazy" decoding="async" />
                ...
                <div className="sector-card-premium fade-in-up delay-2">
                    <div className="sector-card-img-wrapper">
                        <img src="images/commercial-construction.webp" alt="Commercial Construction"  width="736" height="736" loading="lazy" decoding="async" />
        ...
        <div className="container">
            <div className="two-column" style={{"gap":"60px"}}>
                ...
                <div className="fade-in-right col-image" style={{"position":"relative"}}>
                    ...
                    <img src="images/safety and quality iamge.webp" alt="AXIS Infinity Structure Safety QA/QC site inspection" style={{"width":"100%","height":"350px","objectFit":"cover","borderRadius":"12px","boxShadow":"0 20px 40px rgba(0,0,0,0.15)"}}  width="1200" height="674" loading="lazy" decoding="async" />
            ...
            <div className="two-column" style={{"gap":"60px","alignItems":"stretch"}}>
                <div className="fade-in-left col-image" style={{"maxWidth":"90%","margin":"0 auto","height":"100%","position":"relative"}}>
                    ...
                    <div style={{"borderRadius":"16px","overflow":"hidden","boxShadow":"0 30px 60px rgba(0,0,0,0.4)","position":"relative","zIndex":"2","height":"100%"}}>
                        <img src="images/saudi_tower_vertical.webp" alt="Riyadh towers representing KSA Vision 2030" style={{"width":"100%","height":"100%","objectFit":"cover","display":"block","minHeight":"500px"}}  width="1024" height="1024" loading="lazy" decoding="async" />
        ...
        <div className="container">
            <div className="two-column" style={{"gap":"50px","alignItems":"center"}}>
                <div className="col-image fade-in-up">
                    <img src="images/careers_homepage.webp" alt="Join AXIS INFINITY STRUCTURE" style={{"width":"100%","borderRadius":"12px","boxShadow":"0 10px 40px rgba(0,0,0,0.4)"}}  width="1024" height="1024" loading="lazy" decoding="async" />
                </div>
