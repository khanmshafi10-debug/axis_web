          ...
          <div className="footer-brand">
            <div className="logo mb-3">
              <Link to="/" className="logo-link brand-logo-wrapper">
                <img src="images/axis logo.webp" alt="Axis Infinity Structure, Engineering &amp; Infrastructure" className="brand-logo" width="1057" height="443" loading="lazy" decoding="async" style={{ width: "auto", height: "62px", aspectRatio: "1057 / 443", objectFit: "contain" }}  />
              </Link>
            </div>
